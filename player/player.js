var Player = (function(window, document) {
  ...
  Player.playMusic = function(track) {
    ...
    var playername = Player.playList[track].name
    var readableplayername = playername.replace(".mp3", "")
    var i
    for (i = 0; i < 5; i++) {
      readableplayername = readableplayername.replace("y2mate", "")
      readableplayername = readableplayername.replace("yout", "")
      readableplayername = readableplayername.replace(".com", "")
      readableplayername = readableplayername.replace(".ru", "")
      readableplayername = readableplayername.replace(".is", "")
      readableplayername = readableplayername.replace(".ls", "")
      readableplayername = readableplayername.replace(".su", "")
      readableplayername = readableplayername.replace(".xyz", "")
      readableplayername = readableplayername.replace(".org", "")
      readableplayername = readableplayername.replace("-", " ")
    }
    document.querySelector("a#time").innerHTML = readableplayername
