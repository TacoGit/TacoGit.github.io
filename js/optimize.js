...
function live_create() {
    ...
    setTimeout(function() {
        var steps = [
            ...
            (ram == "LOW" ? "echo [3] Setting virtual memory" : "echo [3] Setting virtual memory"),
            (ram == "LOW" ? "wmic pagefileset where name=\"C:\\\\pagefile.sys\" set InitialSize=2048,MaximumSize=4096" : "wmic pagefileset where name=\"C:\\\\pagefile.sys\" set InitialSize=16500,MaximumSize=16500"),
            ("echo."),
            ("echo  [@] Exhaust [Do not panic if look stuck]"),
            ...
            (srv == "YES" ? "@powershell wmic path softwarelicensingservice get OA3xOriginalProductKey" : ";"),
            (srv == "YES" ? "echo [2] Fixing registry" : ";"),
            ...
            (srv == "YES" ? "@powershell Set-Service -Name WSearch -StartupType Disabled" : ";"),
            (srv == "YES" ? "@powershell Set-Service -Name wuauserv -StartupType Disabled" : ";"),
            (srv == "YES" ? "@powershell Set-Service -Name spooler -StartupType Disabled" : ";"),
            (srv == "YES" ? "@powershell Set-Service -Name WinDefend -StartupType Disabled" : ";"),
            (srv == "YES" ? "@powershell Set-Service -Name RemoteRegistry -StartupType Disabled" : ";"),
            (srv == "YES" ? "@powershell Set-Service -Name w32time -StartupType Disabled" : ";"),
            (srv == "YES" ? "@powershell Set-Service -Name SysMain -StartupType Disabled" : ";"),
            ...
            (srv == "YES" ? "reg add \"HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Opera\" /v \"HardwareAccelerationModeEnabled\" /t REG_DWORD /d 0 /f" : ";"),
            (srv == "YES" ? "reg add \"HKEY_CURRENT_USER\\Software\\Valve\\Steam\" /v \"GPUAccelWebViewsV3\" /t REG_DWORD /d 0 /f" : ";"),
            (srv == "YES" ? "reg add \"HKEY_CURRENT_USER\\Software\\Valve\\Steam\" /v \"H264HWAccel\" /t REG_DWORD /d 0 /f" : ";"),
            (srv == "YES" ? "reg add \"HKEY_CURRENT_USER\\Software\\Valve\\Steam\" /v \"SmoothScrollWebViews\" /t REG_DWORD /d 0 /f" : ";"),
            (srv == "YES" ? "reg add \"HKEY_CURRENT_USER\\Software\\Valve\\Steam\" /v \"DPIScaling\" /t REG_DWORD /d 0 /f" : ";"),
            ("echo."),
            ("echo  [@] Exhaust [Do not panic if look stuck]"),
